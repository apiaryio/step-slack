...
export MESSAGE_RESULT=$WERCKER_RESULT
...
export MESSAGE="$MESSAGE_RESULT: <$ACTION_URL|$WERCKER_SHORT_BUILD_ID> for <$GIT_REPOSITORY_URL|$WERCKER_GIT_OWNER/$WERCKER_GIT_REPOSITORY> by $WERCKER_STARTED_BY on branch <$GIT_COMMIT_URL|$WERCKER_GIT_BRANCH>"
